...
//
//public class DashboardBukuActivity1 extends AppCompatActivity
...
//        SharedPreferences preferences = DashboardBukuActivity1.this
...
//            @Override
//            public void onClick(View view) {
//                changeContent(DashboardBukuFragment.newInstance(DashboardBukuActivity1.this));
//            }
//        });
//        riwayatBtn.setOnClickListener(new View.OnClickListener() {
//            @Override
//            public void onClick(View view) {
//                changeContent(RiwayatFragment.newInstance(DashboardBukuActivity1.this));
//            }
//        });
...
//            startActivity(new Intent(DashboardBukuActivity1.this, ProfileActivity.class));
//        } else if (id == R.id.nav_help) {
//            startActivity(new Intent(DashboardBukuActivity1.this, BantuanActivity.class));
...
//                Toast.makeText(DashboardBukuActivity1.this, e.getMessage().toString(), Toast.LENGTH_SHORT).show();
//            }
...
//                        Session.logout(DashboardBukuActivity1.this);
//                        startActivity(new Intent(DashboardBukuActivity1.this, LoginActivity.class));
//                        finish();
//                    }
//                })
//                .show();
